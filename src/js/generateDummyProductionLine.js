...
export default function (){
    ...
    const
        ...
        s5  = new Station('5FC03', EfficiencyLevel.High, '90%'),
        s6  = new Station('6FC04', EfficiencyLevel.High, '90%'),
        s7  = new Station('7FD01', EfficiencyLevel.High, '90%'),
        s8  = new Station('8KAR9605', EfficiencyLevel.Moderate),
        s9  = new Station('9MAN8695', EfficiencyLevel.High),
        s10 = new Station('10FRS', EfficiencyLevel.Low, '20%'),
        s11 = new Station('11QP-98', EfficiencyLevel.Moderate, '70%'),
    ...
    const
        ...
        buffer3 = new Buffer('10%', EfficiencyLevel.Moderate);
